...
#include "rrd.h"
#include "rrdfunc.h"
#cgo linux CFLAGS: -std=c99 -DRRD_LITE -D_DEFAULT_SOURCE -D_GNU_SOURCE -D_BSD_SOURCE -DHAVE_CONFIG_H -D_POSIX_SOURCE -DNUMVERS=1.4009 -DHAVE_MMAP -DHAVE_POSIX_FALLOCATE=1
#cgo darwin CFLAGS: -DRRD_LITE -D_DEFAULT_SOURCE -D_GNU_SOURCE -D_BSD_SOURCE -DHAVE_CONFIG_H -D_POSIX_SOURCE -DNUMVERS=1.4009
#cgo LDFLAGS: -lm -lc
*/
import "C"
